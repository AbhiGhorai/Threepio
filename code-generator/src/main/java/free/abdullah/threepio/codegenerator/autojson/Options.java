...
public class Options {
    ...
    public static final String ADD_SUFFIX = "addJsonParsableSuffix";
    public static final String REMOVE_SUFFIX = "removeJsonParsableSuffix";
    public static final String KEY_CASE = "jsonParsableKeyCase";
